...
<body>
    ...
    <div class="container">
        ...
        <div class="row desc">
            <p>
                Dengan ini menyatakan bahwa mahasiswa tersebut diatas telah mengikuti Sidang Skripsi dan dinyatakan Lulus Sidang dengan judul Skripsi
                <i><?= '"'.strtoupper(str_replace('_', ' ', $ket['judul_skripsi'])).'"' ?>.</i> 
            </p>
        </div>
        <div class="row desc">
            <p>
