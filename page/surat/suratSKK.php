<div class="panel panel-headline">
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <h3 class="panel-title">Form Surat Keterangan Kuliah</h3>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                <form action="?page=surattambahpro" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div clas="form-group">
                                <label>NIM</label><br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div clas="form-group">
                                ...
                                <textarea class="form-control" name="alamat" placeholder="masukkan judul tugas akhir anda..." autocomplete="OFF" required></textarea>
                            </div>
                        </div>
                    </div>
            </div>
